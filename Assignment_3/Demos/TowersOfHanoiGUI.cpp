...
namespace {
    ...
    /* How wide the spindle lines should be. */
    const double kSpindleLineWidth = 3;
    ...
    const Font kResizeMessageFont(FontFamily::SERIF, FontStyle::ITALIC, 24, "#400080");
    ...
    void TowersOfHanoiGUI::setupSpindles() {
        ...
        for (int i = 0; i < kNumSpindles; i++) {
            ...
            spindle.rect->setLineWidth(kSpindleLineWidth);
