 ...
 *
 * Q1:"Once upon a time, the writer Jorge Luis Borges was officiating at a wedding
 *    when, suddenly, fubichao saved Rapa Nui National Park from certain destruction
 *    for the second time in a week. THE END!"
 *
 *
 * Q2: 20:46:59: /Users/chao/Documents/Study/CS 106B 2023 Winter/Assignments
 *              /Assignment 1/Welcome_to_CPP.app/Contents/MacOS/Welcome_to_CPP 崩溃。
 *
 *
 *
 * Q3: 660->635->867->350->887->130->878->660
 *
 *
 *
 *
    ...
    void sayWhatTheyWereDoing(int value) {
        ...
        switch (value % 10) {
            ...
            case 1:
                ...
                break;
            case 2:
                text = "was climbing the Mount Vinson";
                break;
            case 3:
